...
- [ ] 1.4 API Routes + Server Actions para CRUD
...
- [ ] 3.1 KPI cards: total, completadas, en curso, bloqueadas
- [ ] 3.2 Progress rings por área
- [ ] 3.3 Gráfico de avance mensual (Recharts)
- [ ] 3.4 Tabla resumen por dirección estratégica

## Sprint 4: Usuarios y Permisos
- [ ] 4.1 Configurar NextAuth con login Google + credenciales
- [ ] 4.2 Middleware de protección de rutas
- [ ] 4.3 Asignación de responsables a items
- [ ] 4.4 Vista filtrada: Mis Tareas
